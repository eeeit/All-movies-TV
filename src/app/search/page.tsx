      ...
      <div className='px-4 sm:px-10 py-4 sm:py-8 overflow-visible mb-10'>
        ...
        <div className='max-w-[95%] mx-auto mt-12 overflow-visible'>
          {isLoading ? (
              ...
              <div className='mb-8 flex items-center justify-between'>
                ...
                <label className='flex items-center gap-2 cursor-pointer select-none'>
                  ...
                  <div className='relative'>
                    ...
                    />
                    <div className='w-9 h-5 bg-white/10 rounded-full peer-checked:bg-[#f0b90b]/70 transition-colors'></div>
            ...
            // 搜索历史
            <section className='mb-12'>
              <h2 className='mb-4 text-xl font-bold text-white text-left'>
                {t('searchHistory')}
                {searchHistory.length > 0 && (
                  <button
                    onClick={() => {
                    ...
                    className='ml-3 text-sm text-neutral-400 hover:text-[#f0b90b] transition-colors'
                  >
                    {t('clearHistory')}
                  </button>
                )}
                ...
                {searchHistory.map((item) => (
                  <div key={item} className='relative group'>
                    ...
                    <button
                      ...
                      className='absolute -top-1 -right-1 w-4 h-4 opacity-0 group-hover:opacity-100 bg-neutral-500 hover:bg-[#f0b90b] text-black rounded-full flex items-center justify-center text-[10px] transition-colors'
                    >
                      <X className='w-3 h-3' />
                    </button>
                  </div>
