            ...
            className={`flex-1 py-3 px-6 text-center cursor-pointer transition-all duration-200 font-medium
              ${
                activeTab === 'episodes'
                  ...
                  : 'text-gray-700 hover:text-[#f0b90b] bg-black/5 dark:bg-white/5 dark:text-gray-300 dark:hover:text-[#f0b90b] hover:bg-black/3 dark:hover:bg-white/3'
              }
            `.trim()}
          >
            {t('selectEpisode')}
      ...
      {activeTab === 'episodes' && (
        <>
          ...
          <div className='flex items-center gap-4 mb-4 border-b border-gray-300 dark:border-gray-700 -mx-6 px-6 flex-shrink-0'>
                    ...
                    <button
                      ...
                      className={`w-20 relative py-2 text-sm font-medium transition-colors whitespace-nowrap flex-shrink-0 text-center 
                        ${
                          isActive
                            ? 'text-[#f0b90b] dark:text-[#f0b90b]'
                            : 'text-gray-700 hover:text-[#f0b90b] dark:text-gray-300 dark:hover:text-[#f0b90b]'
                        }
                      `.trim()}
                    >
                      {label}
            ...
            {/* 向上/向下按钮 */}
            <button
              className='flex-shrink-0 w-8 h-8 rounded-md flex items-center justify-center text-gray-700 hover:text-[#f0b90b] hover:bg-gray-100 dark:text-gray-300 dark:hover:text-[#f0b90b] dark:hover:bg-white/20 transition-colors transform translate-y-[-4px]'
              onClick={() => {
                // 切换集数排序（正序/倒序）
              ...
              <div className='flex-1 overflow-y-auto space-y-2 pb-20'>
                ...
                <div className='flex-shrink-0 mt-auto pt-2 border-t border-gray-400 dark:border-gray-700'>
                  <button
                    ...
                    className='w-full text-center text-xs text-gray-500 dark:text-gray-400 hover:text-[#f0b90b] dark:hover:text-[#f0b90b] transition-colors py-2'
                  >
                    影片匹配有误？点击去搜索
                  </button>
                </div>
