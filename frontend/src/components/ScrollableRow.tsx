        ...
        >
          ...
          >
            <button
              ...
              className='w-12 h-12 bg-[#161616]/95 rounded-full shadow-lg flex items-center justify-center hover:bg-[#1f1f1f] border border-white/10 transition-transform hover:scale-105'
            >
              <ChevronLeft className='w-6 h-6 text-[#f0b90b]' />
            </button>
          </div>
        </div>
      )}
        ...
        >
          ...
          >
            <button
              ...
              className='w-12 h-12 bg-[#161616]/95 rounded-full shadow-lg flex items-center justify-center hover:bg-[#1f1f1f] border border-white/10 transition-transform hover:scale-105'
            >
              <ChevronRight className='w-6 h-6 text-[#f0b90b]' />
            </button>
          </div>
        </div>
      )}
